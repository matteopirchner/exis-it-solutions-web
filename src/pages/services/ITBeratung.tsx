...
const ITBeratung = () => {
  useEffect(() => {
    document.title = "IT-Beratung | exis Solutions";
  }, []);
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Nutzen Sie unser Expertenwissen für Ihre digitale Transformation. 
                  Wir analysieren Ihre bestehende IT-Landschaft und entwickeln 
                  maßgeschneiderte Strategien für Ihren Geschäftserfolg.
                </p>
                <ul className="space-y-3">
                  {[
                    "IT-Strategie & Roadmap-Entwicklung",
              ...
              {[
                {
                  ...
                  title: "Innovation",
                  description: "Moderne Technologien für Wettbewerbsvorteile"
                },
                {
                  icon: <Target className="w-8 h-8" />,
                  title: "Zielorientiert",
                  description: "Lösungen die zu Ihren Geschäftszielen passen"
                },
                {
                  icon: <Users className="w-8 h-8" />,
                  title: "Erfahrung",
                  description: "Jahrelange Expertise in verschiedenen Branchen"
                }
              ].map((feature, index) => (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Lassen Sie uns über Ihre IT-Strategie sprechen
              </p>
            </div>
