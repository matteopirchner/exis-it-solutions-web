...
import { Cloud, ArrowLeft, Shield, Zap, Users } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Nutzen Sie die Vorteile der Cloud für Ihr Unternehmen. Wir unterstützen Sie 
                  bei der Migration, Verwaltung und Optimierung Ihrer Cloud-Infrastruktur für 
              ...
              {[
                {
                  ...
                  title: "Sicherheit",
                  description: "DSGVO-konforme Cloud-Lösungen mit höchsten Sicherheitsstandards"
                },
                {
                  icon: <Zap className="w-8 h-8" />,
                  title: "Skalierbarkeit",
                  description: "Flexibel anpassbare Ressourcen je nach Ihren Anforderungen"
                },
                {
                  icon: <Users className="w-8 h-8" />,
                  title: "Zusammenarbeit",
                  description: "Verbesserte Teamarbeit durch moderne Collaboration-Tools"
                }
              ].map((feature, index) => (
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Lassen Sie sich über die Vorteile der Cloud beraten
              </p>
            </div>
